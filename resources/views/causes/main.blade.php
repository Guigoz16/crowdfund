            ...
            @foreach($activeCauses as $cause)
              ...
              <div class="causes-item" style="margin-left: 30px; width:200px;">
                  ...
                  <div class="causes-progress">
                      <div class="progress">
                      <div class="progress-bar" role="progressbar" aria-valuenow="{{$progress[$loop->iteration - 1]}}" aria-valuemin="0" aria-valuemax="{{$progress[$loop->iteration - 1]}}">
                             <span>{{$progress[$loop->iteration - 1]}}%</span>
                          </div>
                      </div>
                      <div class="progress-text">
                          <p><strong>Raised:</strong>{{$totalDonations[$loop->iteration - 1]}}</p>
                  ...
                  <div class="causes-btn">
                      ...
                      <a href="{{route('stripe',$cause->id)}}" class="btn btn-custom">Donate Now</a>
                  </div>
              </div>
              </div>
            @endforeach
